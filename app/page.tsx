...
import KarteHeader from "@/components/KarteHeader";
import KarteForms from "@/components/KarteForms";
...
<SaveBar
isSending={isSending}
onSave={()=>sendGenericKarte(isPhoto ? "uploadKarte" : "uploadInclination")}
/>
 </div>
  );
}
